...
const socket = io.connect( 'https://holla-gjls3.ondigitalocean.app/', {
...
socket.on("numberOfOnline", (size) => {
  document.querySelector(
    ".online"
  ).innerHTML = `${size.toLocaleString()} čatotāji`;
});

// event listener for search
document.querySelector("#start").addEventListener("click", (e) => {
  // searching for someone to talk to
  e.target.innerHTML = "Meklē...";
...
document.querySelector("#text").addEventListener("focus", (e) => {
